const movies = [
  ...
  { id: 2, title: "Movie 1", genre: "comedy" },
  { id: 3, title: "Movie 1", genre: "drama" },
  { id: 4, title: "Movie 1", genre: "action" },
  { id: 5, title: "Movie 1", genre: "comedy" },
];
...
function renderMovies(selectedGenre) {
  ...
  const movieListHTML = filteredMovies.map(
    (movie) => `<li><strong>ID:</strong> ${movie.id}<br>
